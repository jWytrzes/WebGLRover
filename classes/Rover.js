...
export default class Rover extends Structure {
    ...
    create() {
        ...
        const wheel1Position = new Position(-19,5,15);
        ...
        const wheel2Position = new Position(19,5,-15);
        ...
        const wheel3Position = new Position(19,5,15);
        ...
        const wheel4Position = new Position(-19,5,-15);
        ...
        const wheel5Position = new Position(0,5,15);
        ...
        const wheel6Position = new Position(0,5,-15);
